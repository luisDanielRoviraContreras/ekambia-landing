  ...
  button
    ...
    &.yellow
      ...
      &:hover
        ...
        box-shadow: 0px 10px 25px 0px -color(color, .3)
      svg
        fill: #000
    &:hover
      background: -color(color)
